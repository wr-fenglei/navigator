...
推进是一个 Codex 技能, 用苏格拉底提问明确目标, 把方案拆成能验证的步骤, 再按实际结果推进到验收
...
```text
使用 $skill-installer 从 https://github.com/wr-fenglei/advance 安装 advance 技能
```
...
```text
$advance 帮我明确这个想法的目标, 拆解方案并推进到验收
```

只讨论目标

```text
$advance 帮我探索这个想法, 这次只讨论目标和验收标准, 先不实施
```

从已有计划继续

```text
$advance 按这份计划继续执行, 核对已有产物和证据, 推进到约定的验收结果
```
